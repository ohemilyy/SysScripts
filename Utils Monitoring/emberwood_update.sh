...
# Old Agent Path
AGENT="/opt/hydrabank/agents/emberwood_agent.sh"
...
wget -t 1 -T 30 -qO $AGENT https://raw.githubusercontent.com/hydridecollective/scripts/main/Utils%20Monitoring/emberwood_agent.sh
echo "... done."
...
# All done
echo "Emberwood agent update completed. It can take up to two (2) minutes for new data to be collected."
